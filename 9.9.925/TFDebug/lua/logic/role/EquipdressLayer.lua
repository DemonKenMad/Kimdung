...
function EquipdressLayer:initAttr(pannl_node,equip)
    ...
    for i = 1,EquipmentManager.kMaxExtraAttributeSize do
        ...
        -- print("txt_attr_extra[notEmptyIndex]:getPositionY() = ",txt_attr_extra[i]:getPositionY())
    end
...
function EquipdressLayer:removeEvents()
    ...
    self.isfirst = true
    -- if self.panelMove and self.panelMove.moveTween then
    --     TFDirector:killTween(self.panelMove.moveTween)
    --     self.panelMove.moveTween = nil
    -- end
end
