...
function EquipreplaceLayer:refreshUI()
    ...
    self:initAttr(self.panel_chuandaizhuangbei,equip, 12);
...
function EquipreplaceLayer:initAttr(pannl_node,equip, dx)
    dx = dx or 0
    ...
    txt_attr_base_val:setPositionX(101)
    txt_attr_base:setPositionX(dx)
    --附加属性
    ...
    for i = 1,EquipmentManager.kMaxExtraAttributeSize do
        ...
        txt_attr_extra[i]:setPositionX(dx)
        txt_attr_extra_val[i]:setPositionX(101)
    end
    --宝石
    local img_gem_bg = {}
    local img_gem = {}
