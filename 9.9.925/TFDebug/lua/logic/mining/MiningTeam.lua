...
function MiningTeam:initUI(ui)
    ...
    local btn_fazhen = TFDirector:getChildByPath(ui, "btn_fazhen")
    btn_fazhen:setVisible(false)
    --Public:addZhenFaIconRukou(btn_fazhen, self.fightType, false)
...
function MiningTeam:onShow()
    ...
    Public:addZhenFaIconForArmy(self.zhenfaNode, self.fightType, false)
end
